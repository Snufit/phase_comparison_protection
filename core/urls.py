...
urlpatterns = [
    ...
    path('methodology/add/<int:device_id>/', views.add_methodology, name='add_methodology_for_device'),
    path('methodology/delete/<int:methodology_id>/', views.delete_methodology, name='delete_methodology'),
    path('methodology/list/', views.list_methodologies, name='list_methodologies'),
    path('methodology/list/<int:device_id>/', views.list_methodologies, name='list_methodologies_for_device'),
]