...
class Command(BaseCommand):
    ...
    Запуск:
        ...
        python manage.py create_protection_half_sets_for_branched_lines --device-model "ТОР 300 ДФЗ 54X"
    """

    help = "Создает полукомплекты защиты для всех линий с ответвлениями"
